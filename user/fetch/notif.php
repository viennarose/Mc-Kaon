...
{
 $datess = date("y-m-d");
 $query = "SELECT * FROM `orders` WHERE date(date)='2022-10-19' and (`status`='ordered' or `status`='deliver') and Customer_id='$myids' Group By Order_id";
 ...
 $query_1 = "SELECT * FROM `orders` WHERE date(date)='2022-10-19' and (`status`='ordered' or `status`='deliver') and Customer_id='$myids' Group By Order_id";
