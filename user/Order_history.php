...
<div class="card-body">
        ...
        <table id="example1" class="table table-striped" cellspacing="0" width="100%">
               ...
               <th  style="text-align: center; font-size: 14px; width: 250px;">Ctrl No.</th>
               <th  style="text-align: center; font-size: 14px; width: 250px;">Menu</th>
               <th  style="text-align: center; font-size: 14px; width: 250px;">Price</th>
               <th  style="text-align: center; font-size: 14px; width: 250px;">Qty</th>
               <th  style="text-align: center; font-size: 14px; width: 250px;">Total Price</th>
               <th style="text-align: center; font-size: 14px; width: 250px;">Date & Time </th>
                        </thead>
                        <tbody>
          </tbody>
                    </table>
