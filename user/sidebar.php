<aside class="main-sidebar sidebar-dark-primary elevation-4" style="">
    ...
    <a href="home" class="brand-link">
      <img src="../images/<?php echo $abouts['Logo'];?>" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light" style="text-align: center;"><?php echo $abouts['Restaurant_name'];?></span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="../images/<?php echo $image;?>" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
 ...
 <li class="nav-item">
  ...
  <path d="M.5 1a.5.5 0 0 0 0 1h1.11l.401 1.607 1.498 7.985A.5.5 0 0 0 4 12h1a2 2 0 1 0 0 4 2 2 0 0 0 0-4h7a2 2 0 1 0 0 4 2 2 0 0 0 0-4h1a.5.5 0 0 0 .491-.408l1.5-8A.5.5 0 0 0 14.5 3H2.89l-.405-1.621A.5.5 0 0 0 2 1H.5zM6 14a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm7 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm-1.646-7.646-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L8 8.293l2.646-2.647a.5.5 0 0 1 .708.708z"/>
              ...
              <p>
               ...
               <span class="right badge badge-danger" id="mycarts"></span>
            </a>
          </li>
...
<li class="nav-item">
  ...
  <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm8-9a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"/>
              ...
              <p>
               ...
               <span class="right badge badge-danger" id="profile"></span>
            </a>
          </li>
...
<script type="text/javascript">
  ...
  xhttp.open("GET", "profile_update.php", true);
  xhttp.send();
...
profile();
 ...
 function mycarts() {
  ...
  xhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
     document.getElementById("mycarts").innerHTML = this.responseText;
    }
  };
  xhttp.open("GET", "mycarts.php", true);
  xhttp.send();
