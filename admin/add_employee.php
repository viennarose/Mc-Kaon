...
<input type="text" class="form-control"  id="lname" name="lname" placeholder="Surname">
...
<div class="col">
 ...
 <input type="text" class="form-control" placeholder="Example: JR  "  id="ext" name="ext" placeholder="Name Extention">
...
<div class="col">
                  ...
                  <label>Sex</label>
                    ...
                    <select class="form-control select2"  id="Sex"  name="Sex">
                      <option selected="selected" hidden="" >-- Select Sex -- </option>
   ...
   <div class="form-group">
                  <label>Employee Position</label>
                    ...
                    <select class="form-control select2"  id="Position"  name="Position">
                      <option selected="selected" hidden="" >-- Select Position -- </option>
                     <?php   
...
<div class="col">
  ...
  <path d="M12.5 16a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Zm.5-5v1.5a.5.5 0 0 1-1 0V11a.5.5 0 0 1 1 0Zm0 3a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0Z"/>
                    ...
                    <input type="Email" class="form-control" style="width: 100%;" id="Email" name="Email">
                    </div>             
  </div>
</div>
...
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt" viewBox="0 0 16 16">
  ...
  <path d="M8 8a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm0 1a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
                    ...
                    <input type="date" class="form-control" style="width: 100%;" id="Started" name="Started">
...
<h6 for="Last" style="">Add Photo</h6>
 ...
 <img id="show" src='../images/profile.jpg'  width="180px" height="180px" style="margin-top: 5px;">  
...
<br>
<center>
      <button type="submit" class="btn btn-primary" value="" style="width: 250px;"><i class="fa fa-plus"></i> Add Employee Info </button>
...
$(function () {
  ...
  function employeeno() {
     var employeeno = $('#employeenos').val();
     
        $.ajax({
            url: 'fetch_single/employeeno.php',
            type: 'POST',
            data: {
            ...
            dataType: 'json',
             ...
             success: function(result) {
                ...
                document.getElementById('ext').value = result.extension;
...
function position() {
     var positioncode = $('#positioncode').val();
        ...
        $.ajax({
            url: 'fetch_single/positioncode.php',
            type: 'POST',
            data: {
            ...
            dataType: 'json',
             ...
             success: function(result) {
                 ...
                 document.getElementById('salaryrate').value = result.monrate;
                document.getElementById('salarygrade').value = result.salgrade;
...
var Position = $('#Position').val();
  ...
  if(lname != '' && fname != '' && mname != '' && Address != '' && Contact_number != '' && Position != '-- Select Position -- ')
  {
   $.ajax({
  ...
  {
   Swal.fire('Please Fill Up ALL Data!', 'otherwise put N/A', 'info');
  }
 });
