        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Position's Info</li>
            </ol>
          </div>
        </div>
...
<div id="admin" class="modal fade">
 ...
 <div class="form-group">
                  <label for="Last">Position Name</label>
...
<input type="text" class="form-control" id="Name" name="Name" placeholder="Name">
               ...
               <div class="form-group">
                  <label for="Last">Postion Rate</label>
                  <div class="input-group">
  ...
  <img src="preloader.gif" alt="" style="width: 50px;height:50px;">
    ...
    <div class="modal-footer">
     ...
     <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
       ...
       <div id="update_rooms" class="modal fade">
 <div class="modal-dialog">
...
<input type="text" class="form-control" id="Names" name="Names" placeholder="Position">
...
<input type="number" class="form-control" id="Rates" name="Rates" placeholder="Rate">
    ...
    if (id) {
        ...
        $.ajax({
            ...
            success: function (result) {
                document.getElementById('Names').value = result.position;
                
                  document.getElementById('Rates').value = result.salary;
