        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Delivery Fee Info</li>
            </ol>
          </div>
        </div>
...
$mysql = mysqli_query($connect, "SELECT * FROM brgy where citymunCode='71218'");
    ...
    if (id) {
        ...
        $.ajax({
            ...
            success: function (result) {
                document.getElementById('Names').value = result.City;
                 document.getElementById('Delivery').value = result.Fee;
